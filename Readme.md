### Olá, esse projeto ensina a usar o git, seguindo as orientações de Rafaella Ballerini,como também outros sites para fazer as definições através do canal dela, assista a vídeo aula no link a seguir:
